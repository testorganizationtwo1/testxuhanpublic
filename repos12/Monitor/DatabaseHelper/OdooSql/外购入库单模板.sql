...
res_partner.company_name as res_partner_company_name,
...
stock_picking.department as stock_picking_department,-- 部门
res_partner.name as res_partner_name-- 业务员
from stock_picking 
...
left join res_users
on res_users.id=stock_picking.business_user
--left join res_partner
