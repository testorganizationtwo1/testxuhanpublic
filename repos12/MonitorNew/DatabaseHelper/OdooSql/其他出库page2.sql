...
--单据号_FBillno
--单据号_FTrantype
product_product.material_code as product_product_material_code,--产品代码_FNumber
product_template.name as product_template_name,--产品代码_FName		
product_product.product_model as product_product_product_model,--产品代码_FModel			** 模板数据为空 => xh
...
stock_warehouse.id as stock_warehouse_id,--发货仓库_FNumber
stock_warehouse.name as stock_warehouse_name,--发货仓库_FName
