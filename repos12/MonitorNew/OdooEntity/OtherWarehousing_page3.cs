...
namespace OdooEntity
{
    ...
    /// 其他入库
    /// </summary>
    public class OtherWarehousing_page3
    {
        ...
        public List<OtherWarehousing_page3> GetEntity(DataTable dt)
        {
            List<OtherWarehousing_page3> list = new List<OtherWarehousing_page3>();
            ...
            {  //oew.stock_picking_date_done = Convert.ToDateTime (dt.Rows[i]["date_done"] == DBNull.Value ? DateTime.Now.AddYears(-10) : Convert.ToDateTime(dt.Rows[i]["date_done"])); //修改
                OtherWarehousing_page3 oew = new OtherWarehousing_page3();
