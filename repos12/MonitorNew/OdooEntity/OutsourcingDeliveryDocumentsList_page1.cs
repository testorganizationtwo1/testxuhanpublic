...
namespace OdooEntity
{
    ...
    /// 委外加工出库
    /// </summary>
    public class OutsourcingDeliveryDocumentsList_page1
    {
        /// <summary>
        /// 审核日期
        /// </summary>
        ...
        public List<OutsourcingDeliveryDocumentsList_page1> GetEntity(DataTable dt)
        {
            List<OutsourcingDeliveryDocumentsList_page1> list = new List<OutsourcingDeliveryDocumentsList_page1>();
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                OutsourcingDeliveryDocumentsList_page1 oew = new OutsourcingDeliveryDocumentsList_page1();
