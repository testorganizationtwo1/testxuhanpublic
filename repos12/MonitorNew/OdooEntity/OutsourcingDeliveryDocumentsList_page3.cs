...
namespace OdooEntity
{
    ...
    /// 委外加工出库
    /// </summary>
    public class OutsourcingDeliveryDocumentsList_page3
    {
        /// <summary>
        /// 单据号_FBillno		
        /// </summary>
        ...
        //最后SNListID
        //最后单据类别
        public List<OutsourcingDeliveryDocumentsList_page3> GetEntity(DataTable dt)
        {
            List<OutsourcingDeliveryDocumentsList_page3> list = new List<OutsourcingDeliveryDocumentsList_page3>();
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                OutsourcingDeliveryDocumentsList_page3 oew = new OutsourcingDeliveryDocumentsList_page3();
