...
namespace OdooEntity
{
    ...
    /// 外购入库单
    /// </summary>
    public class OutsourcingWarehousingOrder_page2
    {
        /// <summary>
        /// 金蝶物料代码
        /// </summary>
        ...
        //交货通知单内码
        //交货通知单分录
        public List<OutsourcingWarehousingOrder_page2> GetEntity(DataTable dt)
        {
            List<OutsourcingWarehousingOrder_page2> list = new List<OutsourcingWarehousingOrder_page2>();
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                OutsourcingWarehousingOrder_page2 oew = new OutsourcingWarehousingOrder_page2();
