...
namespace OdooEntity
{
    ...
    /// 委外入库
    /// </summary>
    public class OutsourcingWarehousing_page3
    {
        /// <summary>
        /// 单据号_FBillno		
        /// </summary>
        ...
        //最后SNListID
        //最后单据类别
        public List<OutsourcingWarehousing_page3> GetEntity(DataTable dt)
        {
            List<OutsourcingWarehousing_page3> list = new List<OutsourcingWarehousing_page3>();
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                OutsourcingWarehousing_page3 oew = new OutsourcingWarehousing_page3();
