...
{   
    ...
    /// 产品入库
    /// </summary>
    public class ProductStorage_page3
    {
        /// <summary>
        /// 单据号_FBillno		
        /// </summary>
        ...
        public List<ProductStorage_page3> GetEntity(DataTable dt)
        {
            List<ProductStorage_page3> list = new List<ProductStorage_page3>();
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ProductStorage_page3 oew = new ProductStorage_page3();
