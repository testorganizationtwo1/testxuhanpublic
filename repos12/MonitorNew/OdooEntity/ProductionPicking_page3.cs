...
namespace OdooEntity
{
    ...
    /// 生产领料
    /// </summary>
    public class ProductionPicking_page3
    {
        /// <summary>
        /// 单据号_FBillno		
        /// </summary>
        ...
        //最后SNListID
        //最后单据类别
        public List<ProductionPicking_page3> GetEntity(DataTable dt)
        {
            List<ProductionPicking_page3> list = new List<ProductionPicking_page3>();
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ProductionPicking_page3 oew = new ProductionPicking_page3();
